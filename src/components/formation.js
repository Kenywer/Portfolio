...
import TituloImage from '../assets/images/Titulo.jpg'; // Ajusta la ruta si no está en public
  ...
  const formations = [
    {
      ...
      year: '2022 - 2024',
      description:
        'Formación técnica enfocada en el desarrollo web, administración de redes y ciberseguridad. Durante estos 2 años y medio, adquirí conocimientos profundos en protección de sistemas, gestión de redes, programación, seguridad informática, y el desarrollo tanto Front-End como Back-End.',
      image: TituloImage,
    },
  ];
